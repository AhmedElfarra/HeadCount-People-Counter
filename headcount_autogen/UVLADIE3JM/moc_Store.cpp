...
QT_MOC_LITERAL(1, 6, 15), // "capacityChanged"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 8), // "capacity"
QT_MOC_LITERAL(4, 32, 13), // "personEntered"
QT_MOC_LITERAL(5, 46, 12) // "personExited"

    },
    "Store\0capacityChanged\0\0capacity\0"
    "personEntered\0personExited"
};
...
void Store::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->capacityChanged((*reinterpret_cast< uint(*)>(_a[1]))); break;
        ...
        {
            typedef void (Store::*_t)(unsigned int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Store::capacityChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Store::capacityChanged(unsigned int _t1)
{
